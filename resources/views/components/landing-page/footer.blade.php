            ...
            <div class="bg-primary rounded-lg">
              <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                 <img src="{{asset('image/logo.png')}}" alt="" srcset="" class="h-10 w-10 object object-center rounded-full">
                ...
                <p class="text-sm text-base-100 sm:ml-6 sm:mt-0 mt-4">© 2020 Doc Aid Medial & Diagnostic —
                  <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-base-100 ml-1" target="_blank">@knyttneve</a>
                </p>
