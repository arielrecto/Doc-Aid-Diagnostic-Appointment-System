            ...
            <div class="container md:px-5 py-18 md:py-24 mx-auto">
                <div class="flex flex-wrap w-full mb-20">
                    <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                        <h1
                            class="text-lg lg:text-3xl md:text-2xl font-medium title-font mb-2 text-gray-900 flex flex-col gap-2">
                        ...
                        <div class="xl:w-1/4 md:w-1/2 p-4 w-full">
                            <a href="{{ route('service.show', ['service' => $service->id]) }}">
                                <div class="bg-base-100 p-6 rounded-lg">
                                    ...
                                    <h2 class="text-lg text-gray-900 font-medium title-font mb-4">{{ $service->name }}
                                    </h2>
...
<div class="w-full min-h-screen flex justify-center gap-2">
    <div class="w-full md:w-5/6 flex flex-col gap-2 py-5">
        <h1 class="text-lg md:text-2xl lg:text-4xl font-bold text-primary capitalize"> Main services offered
        </h1>
            ...
            <div class="container mx-auto flex p-5 md:flex-row flex-col items-center">
                <div
                    ...
                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
                        {{ $services[0]->name ?? 'Stephen Bacolor' }}
                        {{-- <br class="hidden lg:inline-block">readymade gluten --}}
                    </h1>
        ...
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex p-5 md:flex-row flex-col items-center">
                ...
                <div
                    ...
                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
                        {{ $services[1]->name ?? 'Stephen Bacolor' }}
                        {{-- <br class="hidden lg:inline-block">readymade gluten --}}
                    </h1>
