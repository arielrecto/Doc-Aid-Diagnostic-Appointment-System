...
<div class="w-full min-h-screen flex justify-center bg-white py-5" id="aboutus">
    <div class="w-full lg:w-5/6 h-full flex flex-col p-2 lg:p-0">
        ...
        <h1 class="text-lg md:text-2xl lg:text-4xl font-bold text-primary" >
            About Us
        </h1>
                            ...
                            @for ($i = 0; $i < 4; $i++)
                                <div class="p-4 md:w-1/2 w-full">
                                    <div class="h-full bg-gray-100 p-8 rounded">
                                        ...
                                        <p class="text-xs lg:text-base leading-relaxed mb-6">Synth chartreuse iPhone
                                            lomo
                                            cray raw denim brunch
                                            everyday
                                            carry
                                            neutra before they sold out fixie 90's microdosing. Tacos pinterest fanny
                                            pack
                                            venmo,
                                            post-ironic
