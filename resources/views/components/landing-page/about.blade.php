<div class="w-full min-h-screen flex justify-center bg-white py-5" id="aboutus">
    <div class="w-5/6 h-full flex flex-col">
            ...
            <div class="container px-5 py-24 mx-auto flex flex-wrap">
                ...
                <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
                    <div class="flex flex-col mb-10 lg:items-start items-center" data-aos="fade-left">
                        ...
                        <div class="flex-grow">
                            <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Doc Aid Diagnostic Center and Medical Clinic </h2>
                            <p class="leading-relaxed text-base">Was established in the year 2019, and on April 2022 it was sold and transferred to the current owner.</p>
        ...
        <div class="h-screen w-full">
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto">
                    <h1 class="text-3xl font-medium title-font text-gray-900 mb-12 text-center">Feedbacks</h1>
                    <div class="flex flex-wrap -m-4">
                        <div class="p-4 md:w-1/2 w-full">
                            <div class="h-full bg-gray-100 p-8 rounded">
                                ...
                                <p class="leading-relaxed mb-6">Synth chartreuse iPhone lomo cray raw denim brunch
                                    everyday
                                    carry
                                ...
                                <a class="inline-flex items-center">
                                    <img alt="testimonial" src="https://www.scripps.org/sparkle-assets/images/primary_care_physician_1200x750-163ed71c4c87820817101e72ab78901d.jpg"
