...
<div class="w-full min-h-screen flex justify-center bg-white py-5" id="aboutus">
    <div class="w-full lg:w-5/6 h-full flex flex-col p-2 lg:p-0">
            ...
            <div class="container px-5 py-24 mx-auto flex flex-wrap">
                ...
                <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
                    <div class="flex flex-col mb-10 lg:items-start items-center" data-aos="fade-left">
                        ...
                        <div class="flex-grow">
                            <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Doc Aid Diagnostic Center and
                                Medical Clinic </h2>
                            <p class="leading-relaxed text-base">Was established in the year 2019, and on April 2022 it
                                was sold and transferred to the current owner.</p>
                            <a class="mt-3 text-primary inline-flex items-center">View More
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="flex flex-col mb-10 lg:items-start items-center" data-aos="fade-left">
                        ...
                        <div class="flex-grow">
                            <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Owner</h2>
                            <p class="leading-relaxed text-base">Frances Marie A. Revera</p>
                            <a class="mt-3 text-primary inline-flex items-center">View More
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                                ...
                                <div class="h-full bg-gray-100 p-8 rounded">
                                    ...
                                    <div class="relative">
                                        <div class="rating" x-data="displayRating" x-init="initRate({{$feedback->rate}})">
                                            <template x-for="i in 5">
                                                <input type="radio" name="rating-2" :class="`mask mask-star-2 ${ i <= rating ?  'bg-orange-400' : 'bg-gray-500' }`" />
                                            </template>
                                    ...
                                    <a class="inline-flex items-center">
                                        ...
                                        <span class="flex-grow flex flex-col pl-4">
                                            <span class="title-font font-medium text-gray-900">{{$feedback->user->name}}</span>
                                            <span class="text-gray-500 text-sm">{{$feedback->user->roles[0]->name}}</span>
                                        </span>
                                    </a>
                                </div>
                            </div>
                        @empty
                            <div class="p-4 md:w-1/2 w-full">
                                <div class="h-full bg-gray-100 p-8 rounded">
                                    ...
                                    <p class="text-xs lg:text-base leading-relaxed mb-6">Synth chartreuse iPhone lomo
                                        cray raw denim brunch
                                        everyday
                                        carry
                                        neutra before they sold out fixie 90's microdosing. Tacos pinterest fanny pack
                                        venmo,
                                        post-ironic
                                        heirloom try-hard pabst authentic iceland.</p>
                                    <a class="inline-flex items-center">
                                        <img alt="testimonial"
                                            src="https://www.scripps.org/sparkle-assets/images/primary_care_physician_1200x750-163ed71c4c87820817101e72ab78901d.jpg"
                                            class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center">
                                        <span class="flex-grow flex flex-col pl-4">
