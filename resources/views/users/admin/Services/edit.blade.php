<x-app-layout>
    <div class="main-screen">
        ...
        <div class="main-content">
            ...
            <div class="panel grow" x-data="servicesCreate">
                    ...
                    <div class="w-1/3 max-w-full grow-0 flex flex-col gap-2">
                        ...
                        <div class="grow flex flex-col gap-4">
                            ...
                            <div class="c-input-group">
                                ...
                                <input type="text" placeholder="{{$service->name}}" name="name" class="c-input" />
                            </div>
                            @if ($errors->has('name'))
                                <div class="text-error text-sm">
                            ...
                            <div class="grid grid-cols-2 grid-flow-row gap-4">
                                ...
                                <div class="c-input-group">
                                    ...
                                    <input type="text" placeholder="{{$service->price}}" name="price" class="c-input" />
                                    @if ($errors->has('price'))
                                        <div class="text-error text-sm">
                                ...
                                <div class="c-input-group">
                                    <label for="name" class="c-input-label">Initial
                                        Downpayment</label>
                                    <input type="text" placeholder="{{$service->init_payment}}" name="initPayment"
                                        class="c-input" />
                    ...
                    <div class="flex flex-col gap-2 w-2/3 shrink-0 px-2 overflow-y-hidden">
                        ...
                        <div class="grid grid-cols-5 grid-flow-row gap-2">
                            ...
                            <div class="c-input-group">
                                ...
                                <input type="text" placeholder="{{$service->extension_time ?? 'Ex 20 mins' }}" name="extension_time"
                                    class="c-input" />
                            ...
                            <div class="c-input-group">
                                <label for="" class="c-input-label">Extension
                                    Rate</label>
                                <input type="text" placeholder="{{$service->extension_time ?? 'Rate' }}" id="end" name="extension_price"
                                    class="c-input" />
